 ...
 */
public abstract class ListViewAdapter<T> extends BaseAdapter implements
    ...
    public ListViewAdapter(AbsListView view, Collection<T> mDatas, int itemLayoutId) {
        if (mDatas == null) {
...
//        Logger.v("position",position + "" );
    ...
    private AdapterHolder getViewHolder(int position, View convertView,
                                        ViewGroup parent) {
//        Logger.v("AdapterHolder ",position + "" );
