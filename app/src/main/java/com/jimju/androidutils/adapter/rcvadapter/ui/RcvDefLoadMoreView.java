package com.jimju.androidutils.adapter.rcvadapter.ui;
...
public class RcvDefLoadMoreView extends RcvBaseLoadMoreView
{
    ...
    public void setLoadSuccessUI()
    {
        ...
        mImgStatus.setImageResource(mOptions != null ?
                mOptions.getSuccessDrawableResId() : R.mipmap.loadmore_success);
        mTvStatus.setText(mOptions != null ?
    ...
    public void setLoadFailUI()
    {
        ...
        mImgStatus.setVisibility(VISIBLE);
        mImgStatus.setImageResource(mOptions != null ?
                mOptions.getFailDrawableResId() : R.mipmap.loadmore_fail);
        mTvStatus.setText(mOptions != null ?
    ...
    public static final class Options
    {
        ...
        //成功加载的图片
        private int successDrawableResId = R.mipmap.loadmore_success;
        //失败加载的图片
        private int failDrawableResId = R.mipmap.loadmore_fail;
        //未触发状态的文字
